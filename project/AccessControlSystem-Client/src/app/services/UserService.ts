...
export class UserService {
  ...
  getAllEmployees() {
    ...
    let actions: User[] = [];
    return this.http.get<Object[]>('http://35.222.23.193:8083/administrator/api/v1/employee/list/', httpOptions).pipe(
      map(response => {
  ...
  isValidUsername(username: string) {
    ...
    var path = `http://35.222.23.193:8083/administrator/api/v1/employee/isValid/` + username + '/';
    console.log(path);
  ...
  createNewUser(emp: User) {
    ...
    var path = 'http://35.222.23.193:8083/administrator/api/v1/employee';
  ...
  removeUser(id: number) {
    ...
    var path = 'http://35.222.23.193:8083/administrator/api/v1/employee/remove/' + id + '/';
